...
class ResetPassword extends Command
{
    ...
    protected function copyRoutesToProject()
    {
        ...
        $this->copyFile(base_path('vendor/nodes/api-scaffolding/routes/api.php'), sprintf('%s/%s/%s/reset-password.php', $this->projectFolderPath, 'Routes', 'Api'));

        // Copy reset password frontend routes
        $this->copyFile(base_path('vendor/nodes/api-scaffolding/routes/frontend.php'), sprintf('%s/%s/%s/reset-password.php', $this->projectFolderPath, 'Routes', 'Frontend'));
    }
    ...
    protected function copyViewsToProject()
    {
        ...
        $this->copyDirectory(base_path('vendor/nodes/api-scaffolding/resources/views/reset-password'), resource_path('views/vendor/nodes.api/reset-password'));
    }
    ...
    protected function copyAssetsToProject()
    {
        ...
        // Copy reset password views
        $this->copyDirectory(base_path('vendor/nodes/api-scaffolding/resources/assets'), public_path('vendor/nodes/api'));
    }
    ...
    protected function copyAndRunMigration()
    {
        ...
        // Copy reset password views
        $this->copyDirectory(base_path('vendor/nodes/api-scaffolding/database/migrations/reset-password'), database_path('migrations'));
